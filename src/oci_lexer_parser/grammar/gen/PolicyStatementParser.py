...
class PolicyStatementParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "ALLOW", "DENY", "TO", "IN", "WHERE", 
                      ...
                      "NOT", "COMMA", "SLASH", "COLON", "LBRACE", "RBRACE", 
                      "LPAREN", "RPAREN", "EQ", "NEQ", "OCID", "QUOTED_OCID", 
                      "PATTERN", "WORD", "QUOTED", "WS", "OTHER" ]
    ...
    class CondNotInContext(ConditionContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterCondNotIn" ):
                listener.enterCondNotIn(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitCondNotIn" ):
                listener.exitCondNotIn(self)
